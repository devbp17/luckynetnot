  ...
  return (
    ...
    box && (
        ...
        <div className='bg-gray-900 px-20 py-17 flex flex-col justify-center items-center rounded-[10px]'>
            ...
            <input className='bg-gray-800 p-2 font-bold outline-none' type="text" required value={username} onChange={(e) => setUsername(e.target.value)}/>
            <button type='submit' onClick={handleLogin} className={`mt-8 px-21 py-2 cursor-pointer bg-blue-700 hover:bg-blue-600`}>
    ...
    <div className='w-screen bg-gray-900'>
      ...
      <div className='inline-block bg-red-500 cursor-pointer'>
        <p className='mx-4 my-2 font-bold text-[15px]'>Intruksi menggunakan LuckyCoin</p>
    </div>
    </Link>
    <div className='w-screen px-17 my-15 flex flex-row items-center'>
      <h1 className='text-5xl '><span className='font-bold'>LuckyCoins</span> Package</h1>
